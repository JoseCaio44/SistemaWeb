...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, pais: @endereco.pais, setor: @endereco.setor } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, pais: @endereco.pais, setor: @endereco.setor } }
