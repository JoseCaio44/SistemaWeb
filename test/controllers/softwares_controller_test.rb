...
class SoftwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post softwares_url, params: { software: { linguagem: @software.linguagem, tipo: @software.tipo, versao: @software.versao } }
    end
  ...
  test "should update software" do
    patch software_url(@software), params: { software: { linguagem: @software.linguagem, tipo: @software.tipo, versao: @software.versao } }
