...
class HardwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hardware" do
    assert_difference('Hardware.count') do
      post hardwares_url, params: { hardware: { metodo_montagem: @hardware.metodo_montagem } }
    end
  ...
  test "should update hardware" do
    patch hardware_url(@hardware), params: { hardware: { metodo_montagem: @hardware.metodo_montagem } }
