...
class ClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cliente" do
    assert_difference('Cliente.count') do
      post clientes_url, params: { cliente: { celular: @cliente.celular, nome: @cliente.nome, rg: @cliente.rg } }
    end
  ...
  test "should update cliente" do
    patch cliente_url(@cliente), params: { cliente: { celular: @cliente.celular, nome: @cliente.nome, rg: @cliente.rg } }
